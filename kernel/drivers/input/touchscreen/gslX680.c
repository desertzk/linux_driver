...
//10 to 5 
static u32 id_sign[5+1] = {0};
static u8 id_state_flag[5+1] = {0};
static u8 id_state_old_flag[5+1] = {0};
static u16 x_old[5+1] = {0};
static u16 y_old[5+1] = {0};
static u16 x_new = 0;
static u16 y_new = 0;
