...
#define CONFIG_BOOTARGS "lcd=wy070ml tp=ft5x06"    //default:vs070cxn

/*-----------------------------------------------------------------------
 * Miscellaneous configurable options
 */
#define CONFIG_SYS_PROMPT				"GEC6818# "     									/* Monitor Command Prompt   */
#define CONFIG_SYS_LONGHELP				       												/* undef to save memory	   */
#define CONFIG_SYS_CBSIZE		   		800		   											/* Console I/O Buffer Size  */
...
#define CONFIG_DESIGNWARE_ETH			1
	 ...
	 */
		...
		#define CONFIG_PHY_ADDR			4           /* RTL8211 PHY address */
...
#define CONFIG_PMIC
		...
		#define	CFG_IO_I2C3_SCL	((PAD_GPIO_C + 15) | PAD_FUNC_ALT0)
		#define	CFG_IO_I2C3_SDA	((PAD_GPIO_C + 16) | PAD_FUNC_ALT0)
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC1_BUS_WIDTH		4
    #define CONFIG_MMC1_TRANS_MODE      0		/* 1 : DDR_MODE, 0: SDR_MODE */
...
#define	FASTBOOT_PARTS_DEFAULT		\
			"flash=mmc,2:GECuboot:2nd:0x200,0x78000;" \
